...
export const metadata: Metadata = {
  title: "Blog Details Page | Crise.io",
  description: "This is Blog Details Page for Crise.io",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  10 amazing sites to download Fight data 
                </h2>
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="/crise.io/images/blog/author-02.png"
                            alt="author"
                            fill
                          />
                        </div>
                ...
                <div>
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/crise.io/images/blog/blog-details-02.jpg"
                        alt="image"
                        fill
